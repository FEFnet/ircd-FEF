...
extern void sendto_match_butone(const struct Client *one, struct Client *source_p,
				const char *mask, int what, const char *, ...) AFP(5, 6);
extern void sendto_match_butone_tags(const struct Client *one, struct Client *source_p,
